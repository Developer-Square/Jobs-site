      ...
      {userType === "Employer" && (
        <div>
          ...
          <div className="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div className="container mx-auto my-1">
              <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl mx-2">
                ...
                <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
                  <div className="p-8 md:pr-18 md:pl-14 md:py-12 mx-2 md:mx-0 h-full bg-white rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none">
                    ...
                    <p className="text-gray-600 text-justify">
                      ...
                      employees, even if tasks given to them have modest levels
                      of responsibility.
                    </p>
                  </div>
                </div>
                ...
                <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
                  <div className="p-8 md:pr-18 md:pl-14 md:py-12 mx-2 md:mx-0 h-full bg-white rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none">
                    ...
                    <p className="text-gray-600 text-justify">
                      ...
                      business and procedures and can share ideas on strategy,
              ...
              <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl mx-2">
                ...
                <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
                  <div className="p-8 md:pr-18 md:pl-14 md:py-12 mx-2 md:mx-0 h-full bg-white rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none">
                    ...
                    <p className="text-gray-600 text-justify">
                      Internship programs give current employees an opportunity
                      to mentor future leaders in the field, and it can promote
                      a healthy work culture and build company morale.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/*Img Col*/}
            <div className="absolute flex w-full lg:w-2/5 right-0">
